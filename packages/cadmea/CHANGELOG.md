...
- cfeca77: Editor chrome slots for `CollectionEdit` / `createCollectionEditPage`, so a
...
- bb018f7: cadmea: SearchPalette — grouped results, icons, and status/type badges (studio redesign)
...
- 3bfe936: cadmea: `createCollectionCreatePage` now forwards `relationshipOptions` (#98)
