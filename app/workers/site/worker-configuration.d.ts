/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 117b92776bd8784a80ef7b1f0d0fe41a)
...
interface __BaseEnv_Env {
	...
	MEDIA_URL: string;
	CADMEA_URL: string;
	CADMEA: Service /* entrypoint CadmeaService from thebes-cadmea */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_SECRET" | "ADMIN_EMAIL" | "MEDIA_URL" | "CADMEA_URL">> {}
}
